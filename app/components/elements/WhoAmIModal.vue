<template>
    <Page :class="pageClass" actionBarHidden="true" backgroundSpanUnderStatusBar="true">
        <Header :hasHero="false" title="test" :showHeader="true" :showBackBtn="true" :inModal="true">
            <GridLayout rows="*" columns="*" class="page">
                <ScrollView row="0" col="0">
                    <StackLayout class="content" verticalAlignment="top">
                        <Label class="title" text="Voer uw naam en campingplaats of accommodatie in"></Label>
                        <Label class="text" text="Weet u uw plaats niet? Laat dit veld dan leeg." textWrap="true"></Label>
