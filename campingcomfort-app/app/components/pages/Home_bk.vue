    ...
    <Page :class="pageClass" actionBarHidden="true">
        <GridLayout rows="*" columns="*">
            <GridLayout row="0" col="0" rows="auto,auto,*" class="background">
                ...
                <StackLayout row="2" class="bottom-container">
                    <GridLayout rows="*,125">
                        <GridLayout row="0">
                            <Image row="0" class="logo" src="~/assets/images/camping-logo.png"></Image>
                        </GridLayout>
                        <GridLayout row="1">
                            <GridLayout class="nav" columns="*,*,*">
                                <GridLayout col="0" cols="*" rows="*">
                                    <StackLayout horizontalAlignment="center" verticalAlignment="center" class="nav-item">
                                        <Label class="nav-icon fas">{{ 'fa-campground' | fonticon }}</Label>
                                        <Label text="Op de camping"></Label>
                                    </StackLayout>
                                </GridLayout>
                                <GridLayout col="1" cols="*" rows="*">
                                    <StackLayout horizontalAlignment="center" verticalAlignment="center" class="nav-item">
                                        <Label class="nav-icon fas">{{ 'fa-map-marker-alt' | fonticon }}</Label>
                                        <Label text="In de buurt"></Label>
                                    </StackLayout>
                                </GridLayout>
                                <GridLayout col="2" cols="*" rows="*">
                                    <StackLayout horizontalAlignment="center" verticalAlignment="center" class="nav-item">
                                        <Label class="nav-icon fa">{{ 'fa-calendar-alt' | fonticon }}</Label>
                                        <Label text="Evenementen"></Label>
                                    </StackLayout>
                                </GridLayout>
                            </GridLayout>
                        </GridLayout>
